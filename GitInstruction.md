...
### Установка git на ваш ПК
  ...
  1. Переходим на [официальный сайт Git](https://git-scm.com/download/win)
  2. Выбираем опцию - "Click here to download" - **она всегда ведет на самую актуальную версию**
  3. Запускаем скачанный файл
  4. В процесс установки Git выбираем все опции "по умолчанию"
  5. Нажимаем "Install"
  6. Git установлен и готов к работе
