...
Клонирование - копирует файлы из удаленного репозитория на Ваш локальный компьютер (git clone https: ...).
Команда Fork копирует файлы репозитория на Ваш аккаунт в Github. А затем Вы можете клонировать файлы в свой локальный репозиторий на свой компьютер для работы в каталоге и дальнейшего Push на аккаунт Github.
