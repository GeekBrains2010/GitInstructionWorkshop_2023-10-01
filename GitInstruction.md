...
В командной работе бывает трудно уследить за версиями файлов, изменениями и их авторами. Системы контроля версий нужны для того, чтобы упорядочивать версии файлов и их авторов, а также облегчить доступ к ним.
